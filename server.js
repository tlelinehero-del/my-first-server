...
app.get('/', async (req, res) => {
  try {
    ...
    client.release();
    // สร้างหน้าเว็บ HTML (มีฟอร์มสำหรับกรอกข้อมูล และตารางแสดงผล)
    let html = `
<!DOCTYPE html>
<html>
<head>
...
<style>
body { font-family: Tahoma, sans-serif; padding: 20px; background-color: #f4f7f6; }
...
.btn-add { background-color: #28a745; color: white; padding: 10px 15px; border: none; border-radius: 4px; cursor: pointer; }
...
<button type="submit" class="btn-delete" onclick="return confirm('ยืนยันการลบข้อมูลนี้?')">ลบ</button>
</form>
</td>
</tr>
`;
